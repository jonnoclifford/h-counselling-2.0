...
export default function Hero() {
  return (
    <section className="relative md:min-h-screen flex items-center overflow-hidden pt-28 pb-16 md:pt-0 md:pb-0">
      {/* Decorative blobs */}
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <AnimateIn delay={0.2}>
              <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-warm-charcoal leading-[1.1] mb-6">
                You don&apos;t need to have it all figured out
              </h1>
            </AnimateIn>

            <AnimateIn delay={0.35}>
              <p className="text-warm-muted text-xl md:text-2xl leading-relaxed max-w-lg mb-8">
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <AnimateIn delay={0.3} direction="right">
              <div className="relative w-80 h-80 md:w-[420px] md:h-[420px] lg:w-[500px] lg:h-[500px]">
                ...
                <div className="absolute inset-0 bg-[#E1DDE8] rounded-full scale-110" />
                <Image
